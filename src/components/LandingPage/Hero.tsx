  ...
  return (
    <section className="relative w-full min-h-screen flex flex-col items-center justify-center pt-20 overflow-hidden bg-slate-50">
      ...
      <div className="relative z-20 text-center max-w-4xl mx-auto px-6 mt-[-10vh]">
        <h1 className="text-4xl md:text-6xl font-black tracking-tight text-slate-900 mb-6 leading-tight drop-shadow-sm">
          해외주식 포트폴리오,<br />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">AI와 함께</span> 스마트하게 관리하세요
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <button 
            ...
            className="group bg-blue-600 hover:bg-blue-700 text-white text-lg font-bold py-4 px-10 rounded-full transition-all shadow-xl shadow-blue-200 hover:shadow-2xl hover:shadow-blue-300 transform hover:-translate-y-1 flex items-center gap-2"
          >
            무료로 시작하기
